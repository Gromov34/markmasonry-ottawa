...
const translations = {
  en: {
    ...
    'services.restoration.title': 'Brick Restoration',
    'services.restoration.desc': 'Professional brick restoration and repair services to extend the life of your masonry.',
    ...
    'about.description': 'Founded by Mark Kulykov, MarkMasonry has been the trusted choice for residential masonry services in Ottawa and the surrounding region. Our team of skilled craftsmen combines traditional techniques with modern innovation to deliver exceptional results.',
    ...
    'contact.info.address': '411 Peach Tree Lane, Ottawa, ON K1K 2R7',
    'contact.info.phone': '+1 437-552-3366',
    'contact.info.email': 'markmasonry10@gmail.com',
    'contact.info.hours': 'Accepting requests 24/7',
  ...
  fr: {
    ...
    'services.restoration.title': 'Restauration de Brique',
    'services.restoration.desc': 'Services professionnels de restauration et réparation de brique pour prolonger la vie de votre maçonnerie.',
    ...
    'about.description': 'Fondée par Mark Kulykov, MarkMasonry est le choix de confiance pour les services de maçonnerie résidentielle à Ottawa et dans la région environnante. Notre équipe d\'artisans qualifiés combine techniques traditionnelles et innovation moderne pour livrer des résultats exceptionnels.',
    ...
    'contact.info.phone': '+1 437-552-3366',
    'contact.info.email': 'markmasonry10@gmail.com',
    'contact.info.hours': 'Réception des demandes 24/7',
